  ...
  void initState() {
    ...
    getLocation().then((value) {
      WeatherCubit.get(context).getWeatherData(city: city );
          ...
          WeatherCubit.get(context).insertDatabase(name: city);
    ...
    return BlocConsumer<WeatherCubit,WeatherStates>(
      ...
      builder: (context,state){
        ...
        return Scaffold(
          ...
          body:city!='' && cubit.weatherModel!=null? Builder(
            builder: (context) {
                        ...
                        children: [
                          Padding(
                            ...
                            child: Row(
                              ...
                              children:  [
                                Text(
                                    '${cubit.weatherModel!.current!.tempC}'+'\u00B0',style: textStyleManger(60, Colors.white)
                                ),
                                const Spacer(),
                                Lottie.network(
                                    height: 100,
                                    width: 100,
                                    cubit.selectWeatherImage('${WeatherCubit.get(context).weatherModel!.forecast!.forecastday![0].day!.condition!.text}')
                                )
                              ],
                            ),
                          ),
                              ...
                              Padding(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text(
                                        ' Feels like ${cubit.weatherModel!.current!.feelslikeC}\u00B0',
                                        style: textStyleManger(17, ColorManager.white,fontWeight: FontWeight.w500)
                                    ),
                                  ],
                                ),
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              Lottie.network(
                                                  height: 20,
                                                  width: 20,
                                                  cubit.selectWeatherImage('${cubit.weatherModel!.forecast!.forecastday![0].hour![index].condition!.text}')
                                              ),
                                              const SizedBox(height: 5,),
                                              Text(
                                                  '${cubit.weatherModel!.forecast!.forecastday![0].hour![index].tempC}',
                                                  style: textStyleManger(13, ColorManager.white,fontWeight: FontWeight.w500)
                                              ),
                                              const Spacer(),
                                              Row(
                                                children: [
                                                  ...
                                                  Text(
                                                      '${cubit.weatherModel!.forecast!.forecastday![0].hour![index].chanceOfRain}',
                                                      style: textStyleManger(13, ColorManager.white,fontWeight: FontWeight.w500)
                                                  ),
                                      ...
                                      return Stack(
                                        ...
                                        children: [
                                          Positioned(
                                            left: 10,
                                            child: Text(
                                                DateFormat('EEEE').format(DateTime.parse((cubit.weatherModel!.forecast!.forecastday![index].date)!)),
                                          ...
                                          Positioned(
                                            left: 110,
                                            child: Text(
                                                '${cubit.weatherModel!.forecast!.forecastday![index].day!.dailyChanceOfRain}%',
                                                style: textStyleManger(14, ColorManager.whiteDark,)
                                            ),
                                          ),
                                          Text(
                                              '${cubit.weatherModel!.forecast!.forecastday![index].day!.mintempC}\u00B0',
                                              style: textStyleManger(15, ColorManager.white,fontWeight: FontWeight.w500,)
                                          ),
                                          ...
                                          Positioned(
                                            right: 40,
                                            child: Text(
                                                '${cubit.weatherModel!.forecast!.forecastday![index].day!.maxtempC}\u00B0',
                                                style: textStyleManger(15, ColorManager.white,fontWeight: FontWeight.w500,)
                                            ),
                                          ),
                                          Positioned(
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          const SizedBox(height: 5,),
                                          if(cubit.weatherModel!.current!.uv ==1 || cubit.weatherModel!.current!.uv ==2)
                                            Text(
                                                'Low',
                                                style: textStyleManger(18, ColorManager.whiteDark,)
                                            ),
                                          if(cubit.weatherModel!.current!.uv ==3 || cubit.weatherModel!.current!.uv ==4 || cubit.weatherModel!.current!.uv ==5 )
                                            Text(
                                                'Moderate',
                                                style: textStyleManger(18, ColorManager.whiteDark,)
                                            ),
                                          if(cubit.weatherModel!.current!.uv ==6 || cubit.weatherModel!.current!.uv ==7 )
                                            Text(
                                                'High',
                                                style: textStyleManger(18, ColorManager.whiteDark,)
                                            ),
                                          if(cubit.weatherModel!.current!.uv ==8 || cubit.weatherModel!.current!.uv ==9 || cubit.weatherModel!.current!.uv ==10)
                                            Text(
                                                'Very High',
                                                style: textStyleManger(18, ColorManager.whiteDark,)
                                            ),
                                          if(cubit.weatherModel!.current!.uv ==11 )
                                            Text(
                                                'Extreme',
                                                style: textStyleManger(18, ColorManager.whiteDark,)
                                            ),
